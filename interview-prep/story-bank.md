...
### [Feedback] Recalibrating an ambitious junior who misunderstood his own performance
**Source:** Raw story draft - coaching / performance calibration
**Digest:** I hired a very young engineer named Andrey who had strong energy, ambition, and a clear desire to grow fast into a senior role. Early on, he was getting work done, but the quality and task understanding were inconsistent enough that his lead raised concerns about underperformance. In a 1:1, instead of confronting him only with dissatisfaction, I first asked how he thought he was doing. He believed things were going well and that he was on track to become senior soon, which showed that the biggest gap was not only execution but self-calibration. I used that conversation to redefine what seniority actually meant beyond hard skills, focusing on attention to detail, anticipating downstream impact, and communicating proactively in planning and grooming. After that conversation, his behavior improved noticeably: he became more thoughtful, more proactive, and easier to course-correct, which reinforced that underperformance often needs explicit calibration before it can improve.
**Angles:** EM | coaching | feedback | performance | growth
**S (Situation):** A young engineer with clear ambition and visible potential was producing work, but quality gaps and misunderstandings around task expectations were creating concerns about underperformance.
**T (Task):** Help him understand the real gap between his self-perception and his current level, improve his effectiveness, and avoid letting the situation drift into silent frustration between him, his lead, and the team.
**A (Action):** Used a 1:1 to start with self-assessment rather than accusation, surfaced the mismatch between his confidence and actual delivery, reframed seniority as a combination of technical depth, attention to detail, anticipation, and communication, and asked him to become more deliberate in task review, more proactive in grooming and sprint planning, and more aware of how his work affected peers and team execution.
**R (Result):** He started improving almost immediately in the right direction. Mistakes still happened, but they became smaller and easier to correct, and the situation shifted from vague dissatisfaction to active growth. The episode also reinforced a broader management principle: many developers do not recognize underperformance until expectations are made explicit in concrete terms.
**Reflection:** Corrective feedback works best when it starts by calibrating the person’s mental model rather than only naming disappointment. In early-career cases especially, the problem is often not effort but an incomplete picture of what good performance actually looks like.
**Best for questions about:** giving corrective feedback, 1:1s, coaching someone with high ambition, handling underperformance early, calibrating expectations, helping someone grow

### [Migration Leadership] Orchestrating a zero-incident migration from legacy Cloudflare workers to Go services
**Source:** Raw story draft - Ankr migration orchestration
**Digest:** At Ankr, I was tasked not only with implementing part of a legacy migration, but with orchestrating the whole move from a Cloudflare Workers system serving private API traffic into internal Go services that were already handling enterprise traffic. The challenge was broader than code translation: the system carried tribal knowledge, served real production clients, required user migration and data synchronization, and had to be changed while the Go services were still evolving with new feature work. I started by gathering context aggressively through repository analysis, walkthroughs with the legacy team, and documentation so the migration would not depend on repeated verbal explanations. From there I produced a high-level design, decomposed it into roadmap blocks, defined rollout and fallback stages, and spread the implementation across the team in a way that reduced internal blocking and peer-team dependency risk. The migration completed smoothly, with fallbacks prepared throughout, and issues were resolved before they affected real users.
**Angles:** EM | strategy | roadmap | migration | cross-functional | delivery
**S (Situation):** A production legacy system in Cloudflare Workers needed to be migrated into internal Go services, but the work involved live traffic, tribal knowledge, data migration, synchronization, and coordination across teams while the destination system was still actively developing.
**T (Task):** Create a credible migration plan, align the necessary teams, protect production stability, and execute the transition without losing data or disrupting clients.
**A (Action):** Gathered system knowledge through code review and walkthroughs with the legacy lead, documented the findings in Confluence, created a high-level design covering entities, infrastructure changes, and service modifications, accounted for user migration and data synchronization, decomposed the design into roadmap blocks that could be estimated, defined phased rollout and shutdown steps with fallbacks, and distributed the work across the team to reduce blocking inside the group and across peer teams.
**R (Result):** The migration was executed smoothly, the rollout was stable, and issues were handled before real users felt them. The effort also turned tribal knowledge into reusable documentation and converted a risky legacy dependency into a more maintainable internal system.
**Reflection:** Large migrations fail when implementation starts before knowledge, sequencing, and fallback design are solid. The highest leverage part of the work was not writing code first, but turning a fragile system transition into an explicit roadmap with clear interfaces, documentation, and recovery paths.
**Best for questions about:** roadmap shaping, legacy migration planning, leading cross-team execution, change management, risk management, operating safely in production
